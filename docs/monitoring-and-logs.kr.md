...
> 스크린샷 위치: `opcua-job-detail.png`
>
> 권장 장면: OPC UA, Nodes Monitored, Database, Monitored Nodes, Logging Controls가 같이 보이는 상세 화면
...
**View Logs** 버튼을 누르면 해당 Job의 로그 파일 목록과 내용을 볼 수 있습니다.
...
첫 번째 파일이 기본으로 선택될 수 있습니다.

> 스크린샷 위치: `opcua-log-viewer.png`
>
> 권장 장면: 왼쪽 파일 목록과 오른쪽 로그 내용이 같이 보이는 로그 모달
